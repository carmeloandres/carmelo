...
//            '<div class="wp-block-site-logo"><a href="http://localhost/carmeloandres/" class="custom-logo-link" rel="home" aria-current="page"><img width="80" height="44" src="http://localhost/carmeloandres/wp-content/uploads/2023/04/LogoFondoBlanco.png" class="custom-logo" alt="Carmelo Andres" decoding="async" /></a></div>'
...
//            $new_block = preg_replace('/src.*?.png/i', $nueva_imagen, $block_content);
            ...
            $new_block = '<div class="wp-block-site-logo"><a href="'.home_url().'" class="custom-logo-link" rel="home" aria-current="page"><img width="80" height="44" src="'.get_template_directory_uri().'/assets/svg/logo-2021-04-26-blue.svg" class="custom-logo" alt="Carmelo Andres" decoding="async" /></a></div>';
